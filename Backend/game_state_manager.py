...
# Jasper is a pig! Pig! Pig!
        ...
        self.colorSets = {
            ...
            4 : ["#4F2B2B", "#F7F1E4", "#E9CA89", "#A2C1C0"],# ["#FBCBB8", "#FFD073","#82A133","#7DAFD2"],#["#744C27", "#919A5E", "#FFDC70", "#FFF6CD"], #["#FBCBB8", "#FFD073","#82A133","#7DAFD2"], #["#FF7E5F",  "#F0D7A3",   "#A6D1E6", "#5F8D4E"], #["#FFD3D4", "#D5EBE4", "#F8F4E8", "#775C56"] ["#FF7E5F",  "#F0D7A3",   "#A6D1E6", "#DCD0FF"],#["#FF7E5F",  "#F0D7A3",   "#A6D1E6", "#465C47"],#["#04266F", "#3C85D1", "#D460A7", "#E77960"], #["#FFA7A6", "#FFE9C9", "#A0D2F9", "#8DD9C0"], #["#666666",  "#7DF9FF",   "#00BBC9",   "#FFDE21"],
            ...
            6 : ["#A2C1C0",  "#E7C58A",   "#86B05D",   "#C77947",  "#F7E6D4",  "#4B3535"], #["#575876",  "#E7C58A",   "#86B05D",   "#C77947",  "#F7E6D4",  "#4B3535"],#["#333333",  "#7DF9FF",   "#00BBC9",   "#FFDE21",  "#DFE2FF",  "#F06060"],
    ...
    def compute_PPI(self, ):
        ...
        for p in p_alive:
            ...
            curr_p.PPI = round(self.logistic_function(z_score) * 100, 2)
    ...
    def handle_battle(self, data):
        ...
        if atk_p.skill:
            ...
            if atk_p.skill.name == "Mass Mobilization" and atk_p.skill.active:
